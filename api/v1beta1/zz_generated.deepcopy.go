...
func (in *AzureManagedControlPlaneClassSpec) DeepCopyInto(out *AzureManagedControlPlaneClassSpec) {
	*out = *in
	...
	if in.MarketplaceExtensions != nil {
		in, out := &in.MarketplaceExtensions, &out.MarketplaceExtensions
		*out = make([]MarketplaceExtension, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MarketplaceExtension) DeepCopyInto(out *MarketplaceExtension) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MarketplaceExtension.
func (in *MarketplaceExtension) DeepCopy() *MarketplaceExtension {
	if in == nil {
		return nil
	}
	out := new(MarketplaceExtension)
	in.DeepCopyInto(out)
	return out
}
