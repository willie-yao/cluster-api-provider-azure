...
func (in *AzureManagedControlPlaneClassSpec) DeepCopyInto(out *AzureManagedControlPlaneClassSpec) {
	*out = *in
	...
	if in.FleetHub != nil {
		in, out := &in.FleetHub, &out.FleetHub
		*out = new(FleetHub)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FleetHub) DeepCopyInto(out *FleetHub) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FleetHub.
func (in *FleetHub) DeepCopy() *FleetHub {
	if in == nil {
		return nil
	}
	out := new(FleetHub)
