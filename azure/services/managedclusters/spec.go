...
func buildAutoScalerProfile(autoScalerProfile *AutoScalerProfile) *asocontainerservicev1preview.ManagedClusterProperties_AutoScalerProfile {
	if autoScalerProfile == nil {
		return nil
	}

	mcAutoScalerProfile := &asocontainerservicev1preview.ManagedClusterProperties_AutoScalerProfile{
	...
	if autoScalerProfile.Expander != nil {
		mcAutoScalerProfile.Expander = ptr.To(asocontainerservicev1preview.ManagedClusterProperties_AutoScalerProfile_Expander(*autoScalerProfile.Expander))
	}
...
func (s *ManagedClusterSpec) getManagedClusterVersion(existing *asocontainerservicev1preview.ManagedCluster) string {
...
func (s *ManagedClusterSpec) Parameters(ctx context.Context, existingObj genruntime.MetaObject) (params genruntime.MetaObject, err error) {
	...
	managedCluster.Spec.Identity = &asocontainerservicev1preview.ManagedClusterIdentity{
		Type: ptr.To(asocontainerservicev1preview.ManagedClusterIdentity_Type_SystemAssigned),
	}
	...
	managedCluster.Spec.ServicePrincipalProfile = &asocontainerservicev1preview.ManagedClusterServicePrincipalProfile{
		ClientId: ptr.To("msi"),
	}
	managedCluster.Spec.NetworkProfile = &asocontainerservicev1preview.ContainerServiceNetworkProfile{
		NetworkPlugin:   azure.AliasOrNil[asocontainerservicev1preview.NetworkPlugin](&s.NetworkPlugin),
		LoadBalancerSku: azure.AliasOrNil[asocontainerservicev1preview.LoadBalancerSku](&s.LoadBalancerSKU),
		NetworkPolicy:   azure.AliasOrNil[asocontainerservicev1preview.NetworkPolicy](&s.NetworkPolicy),
	}
	if s.NetworkDataplane != nil {
		managedCluster.Spec.NetworkProfile.NetworkDataplane = ptr.To(asocontainerservicev1preview.NetworkDataplane(*s.NetworkDataplane))
	}
	...
	if decodedSSHPublicKey != nil {
		managedCluster.Spec.LinuxProfile = &asocontainerservicev1preview.ContainerServiceLinuxProfile{
			AdminUsername: ptr.To(azure.DefaultAKSUserName),
			Ssh: &asocontainerservicev1preview.ContainerServiceSshConfiguration{
				PublicKeys: []asocontainerservicev1preview.ContainerServiceSshPublicKey{
					{
	...
	if s.NetworkPluginMode != nil {
		managedCluster.Spec.NetworkProfile.NetworkPluginMode = ptr.To(asocontainerservicev1preview.NetworkPluginMode(*s.NetworkPluginMode))
	}
	...
	managedCluster.Spec.OperatorSpec = &asocontainerservicev1preview.ManagedClusterOperatorSpec{
		Secrets: &asocontainerservicev1preview.ManagedClusterOperatorSecrets{
	...
	if s.AADProfile != nil {
		managedCluster.Spec.AadProfile = &asocontainerservicev1preview.ManagedClusterAADProfile{
	...
	for i := range s.AddonProfiles {
		if managedCluster.Spec.AddonProfiles == nil {
			managedCluster.Spec.AddonProfiles = map[string]asocontainerservicev1preview.ManagedClusterAddonProfile{}
		}
		item := s.AddonProfiles[i]
		addonProfile := asocontainerservicev1preview.ManagedClusterAddonProfile{
	...
	if s.SKU != nil {
		tierName := asocontainerservicev1preview.ManagedClusterSKU_Tier(s.SKU.Tier)
		managedCluster.Spec.Sku = &asocontainerservicev1preview.ManagedClusterSKU{
			Name: ptr.To(asocontainerservicev1preview.ManagedClusterSKU_Name("Base")),
	...
	if s.APIServerAccessProfile != nil {
		managedCluster.Spec.ApiServerAccessProfile = &asocontainerservicev1preview.ManagedClusterAPIServerAccessProfile{
	...
	if s.OutboundType != nil {
		managedCluster.Spec.NetworkProfile.OutboundType = ptr.To(asocontainerservicev1preview.ContainerServiceNetworkProfile_OutboundType(*s.OutboundType))
	}
	...
	if s.KubeletUserAssignedIdentity != "" {
		managedCluster.Spec.IdentityProfile = map[string]asocontainerservicev1preview.UserAssignedIdentity{
			kubeletIdentityKey: {
	...
	if s.HTTPProxyConfig != nil {
		managedCluster.Spec.HttpProxyConfig = &asocontainerservicev1preview.ManagedClusterHTTPProxyConfig{
	...
	if s.OIDCIssuerProfile != nil {
		managedCluster.Spec.OidcIssuerProfile = &asocontainerservicev1preview.ManagedClusterOIDCIssuerProfile{
			Enabled: s.OIDCIssuerProfile.Enabled,
		}
		if ptr.Deref(s.OIDCIssuerProfile.Enabled, false) {
			managedCluster.Spec.OperatorSpec.ConfigMaps = &asocontainerservicev1preview.ManagedClusterOperatorConfigMaps{
	...
	if s.AutoUpgradeProfile != nil {
		managedCluster.Spec.AutoUpgradeProfile = &asocontainerservicev1preview.ManagedClusterAutoUpgradeProfile{
			UpgradeChannel: (*asocontainerservicev1preview.ManagedClusterAutoUpgradeProfile_UpgradeChannel)(s.AutoUpgradeProfile.UpgradeChannel),
		}
	}

	if s.SecurityProfile != nil {
		securityProfile := &asocontainerservicev1preview.ManagedClusterSecurityProfile{}
		if s.SecurityProfile.AzureKeyVaultKms != nil {
			securityProfile.AzureKeyVaultKms = &asocontainerservicev1preview.AzureKeyVaultKms{
			...
			if s.SecurityProfile.AzureKeyVaultKms.KeyVaultNetworkAccess != nil {
				...
				securityProfile.AzureKeyVaultKms.KeyVaultNetworkAccess = ptr.To(asocontainerservicev1preview.AzureKeyVaultKms_KeyVaultNetworkAccess(keyVaultNetworkAccess))
			}
		...
		if s.SecurityProfile.Defender != nil {
			securityProfile.Defender = &asocontainerservicev1preview.ManagedClusterSecurityProfileDefender{
			...
			if s.SecurityProfile.Defender.SecurityMonitoring != nil {
				securityProfile.Defender.SecurityMonitoring = &asocontainerservicev1preview.ManagedClusterSecurityProfileDefenderSecurityMonitoring{
					Enabled: s.SecurityProfile.Defender.SecurityMonitoring.Enabled,
				}
			}
		}
		if s.SecurityProfile.ImageCleaner != nil {
			securityProfile.ImageCleaner = &asocontainerservicev1preview.ManagedClusterSecurityProfileImageCleaner{
		...
		if s.SecurityProfile.WorkloadIdentity != nil {
			securityProfile.WorkloadIdentity = &asocontainerservicev1preview.ManagedClusterSecurityProfileWorkloadIdentity{
	...
	stable.Spec.AgentPoolProfiles = nil
	if (!s.Preview && managedCluster.Status.AgentPoolProfiles == nil) || (s.Preview && stable.Status.AgentPoolProfiles == nil) {
...
func (s *ManagedClusterSpec) GetLoadBalancerProfile() (loadBalancerProfile *asocontainerservicev1preview.ManagedClusterLoadBalancerProfile) {
	loadBalancerProfile = &asocontainerservicev1preview.ManagedClusterLoadBalancerProfile{
	...
	if s.LoadBalancerProfile.ManagedOutboundIPs != nil {
		loadBalancerProfile.ManagedOutboundIPs = &asocontainerservicev1preview.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs{Count: s.LoadBalancerProfile.ManagedOutboundIPs}
	}
	if len(s.LoadBalancerProfile.OutboundIPPrefixes) > 0 {
		loadBalancerProfile.OutboundIPPrefixes = &asocontainerservicev1preview.ManagedClusterLoadBalancerProfile_OutboundIPPrefixes{
	...
	if len(s.LoadBalancerProfile.OutboundIPs) > 0 {
		loadBalancerProfile.OutboundIPs = &asocontainerservicev1preview.ManagedClusterLoadBalancerProfile_OutboundIPs{
...
func convertToResourceReferences(resources []string) []asocontainerservicev1preview.ResourceReference {
	resourceReferences := make([]asocontainerservicev1preview.ResourceReference, len(resources))
	for i := range resources {
		resourceReferences[i] = asocontainerservicev1preview.ResourceReference{
...
func getIdentity(identity *infrav1.Identity) (managedClusterIdentity *asocontainerservicev1preview.ManagedClusterIdentity, err error) {
	if identity.Type == "" {
		return
	}

	managedClusterIdentity = &asocontainerservicev1preview.ManagedClusterIdentity{
		Type: ptr.To(asocontainerservicev1preview.ManagedClusterIdentity_Type(identity.Type)),
	}
	if ptr.Deref(managedClusterIdentity.Type, "") == asocontainerservicev1preview.ManagedClusterIdentity_Type_UserAssigned {
		...
		managedClusterIdentity.UserAssignedIdentities = []asocontainerservicev1preview.UserAssignedIdentityDetails{
			{
				Reference: genruntime.ResourceReference{
