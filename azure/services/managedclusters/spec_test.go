...
func TestParameters(t *testing.T) {
	...
	t.Run("no existing preview managed cluster", func(t *testing.T) {
		...
		expected := &asocontainerservicev1preview.ManagedCluster{
			Spec: asocontainerservicev1preview.ManagedCluster_Spec{
				AadProfile: &asocontainerservicev1preview.ManagedClusterAADProfile{
					EnableAzureRBAC: ptr.To(false),
					Managed:         ptr.To(true),
				},
				AddonProfiles: map[string]asocontainerservicev1preview.ManagedClusterAddonProfile{
					"addon name": {
						Config:  map[string]string{"addon": "config"},
						Enabled: ptr.To(true),
					},
				},
				AgentPoolProfiles: []asocontainerservicev1preview.ManagedClusterAgentPoolProfile{
					{
						Count:             ptr.To(5),
						EnableAutoScaling: ptr.To(false),
						Mode:              ptr.To(asocontainerservicev1preview.AgentPoolMode("mode")),
						Name:              ptr.To("agentpool"),
						OsDiskSizeGB:      ptr.To(asocontainerservicev1preview.ContainerServiceOSDisk(0)),
						Type:              ptr.To(asocontainerservicev1preview.AgentPoolType_VirtualMachineScaleSets),
						Tags:              map[string]string{"from": "patches"},
					},
				},
				ApiServerAccessProfile: &asocontainerservicev1preview.ManagedClusterAPIServerAccessProfile{
					AuthorizedIPRanges: []string{"authorized ip ranges"},
				},
				AutoScalerProfile: &asocontainerservicev1preview.ManagedClusterProperties_AutoScalerProfile{
					Expander: ptr.To(asocontainerservicev1preview.ManagedClusterProperties_AutoScalerProfile_Expander("expander")),
				},
				AutoUpgradeProfile: &asocontainerservicev1preview.ManagedClusterAutoUpgradeProfile{
					UpgradeChannel: ptr.To(asocontainerservicev1preview.ManagedClusterAutoUpgradeProfile_UpgradeChannel_Rapid),
				},
				AzureName:            "name",
				DisableLocalAccounts: ptr.To(true),
				DnsPrefix:            ptr.To("dns prefix"),
				EnableRBAC:           ptr.To(true),
				HttpProxyConfig: &asocontainerservicev1preview.ManagedClusterHTTPProxyConfig{
					NoProxy: []string{"noproxy"},
				},
				Identity: &asocontainerservicev1preview.ManagedClusterIdentity{
					Type: ptr.To(asocontainerservicev1preview.ManagedClusterIdentity_Type_UserAssigned),
					UserAssignedIdentities: []asocontainerservicev1preview.UserAssignedIdentityDetails{
						{
							Reference: genruntime.ResourceReference{
								ARMID: "user assigned id",
							},
				...
				IdentityProfile: map[string]asocontainerservicev1preview.UserAssignedIdentity{
					kubeletIdentityKey: {
						ResourceReference: &genruntime.ResourceReference{
							ARMID: "kubelet id",
						},
				...
				KubernetesVersion: ptr.To("version"),
				LinuxProfile: &asocontainerservicev1preview.ContainerServiceLinuxProfile{
					AdminUsername: ptr.To(azure.DefaultAKSUserName),
				...
				Location: ptr.To("location"),
				NetworkProfile: &asocontainerservicev1preview.ContainerServiceNetworkProfile{
					DnsServiceIP: ptr.To("0.0.0.10"),
					LoadBalancerProfile: &asocontainerservicev1preview.ManagedClusterLoadBalancerProfile{
						ManagedOutboundIPs: &asocontainerservicev1preview.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs{
							Count: ptr.To(16),
						},
						OutboundIPPrefixes: &asocontainerservicev1preview.ManagedClusterLoadBalancerProfile_OutboundIPPrefixes{
							PublicIPPrefixes: []asocontainerservicev1preview.ResourceReference{
								{
									Reference: &genruntime.ResourceReference{
										ARMID: "outbound ip prefixes",
									},
						...
						OutboundIPs: &asocontainerservicev1preview.ManagedClusterLoadBalancerProfile_OutboundIPs{
							PublicIPs: []asocontainerservicev1preview.ResourceReference{
								{
									Reference: &genruntime.ResourceReference{
										ARMID: "outbound ips",
									},
					...
					LoadBalancerSku:   ptr.To(asocontainerservicev1preview.LoadBalancerSku("lb sku")),
					NetworkPlugin:     ptr.To(asocontainerservicev1preview.NetworkPlugin("network plugin")),
					NetworkPluginMode: ptr.To(asocontainerservicev1preview.NetworkPluginMode("network plugin mode")),
					NetworkPolicy:     ptr.To(asocontainerservicev1preview.NetworkPolicy("network policy")),
					OutboundType:      ptr.To(asocontainerservicev1preview.ContainerServiceNetworkProfile_OutboundType("outbound type")),
					PodCidr:           ptr.To("pod cidr"),
					ServiceCidr:       ptr.To("0.0.0.0/10"),
				},
				NodeResourceGroup: ptr.To("node rg"),
				OidcIssuerProfile: &asocontainerservicev1preview.ManagedClusterOIDCIssuerProfile{
					Enabled: ptr.To(true),
				},
				OperatorSpec: &asocontainerservicev1preview.ManagedClusterOperatorSpec{
					...
					ConfigMaps: &asocontainerservicev1preview.ManagedClusterOperatorConfigMaps{
						OIDCIssuerProfile: &genruntime.ConfigMapDestination{
							Name: oidcIssuerURLConfigMapName("cluster"),
							Key:  oidcIssuerProfileURL,
						},
				...
				ServicePrincipalProfile: &asocontainerservicev1preview.ManagedClusterServicePrincipalProfile{
					ClientId: ptr.To("msi"),
				},
				Sku: &asocontainerservicev1preview.ManagedClusterSKU{
					Name: ptr.To(asocontainerservicev1preview.ManagedClusterSKU_Name_Base),
					Tier: ptr.To(asocontainerservicev1preview.ManagedClusterSKU_Tier("sku tier")),
				},
				Tags: map[string]string{
					"Name": "name",
					"sigs.k8s.io_cluster-api-provider-azure_cluster_cluster": "owned",
				...
				SecurityProfile: &asocontainerservicev1preview.ManagedClusterSecurityProfile{
					AzureKeyVaultKms: &asocontainerservicev1preview.AzureKeyVaultKms{
						Enabled:               ptr.To(true),
						KeyId:                 ptr.To("KeyID"),
						KeyVaultNetworkAccess: ptr.To(asocontainerservicev1preview.AzureKeyVaultKms_KeyVaultNetworkAccess_Public),
					},
					Defender: &asocontainerservicev1preview.ManagedClusterSecurityProfileDefender{
						LogAnalyticsWorkspaceResourceReference: &genruntime.ResourceReference{
							ARMID: "LogAnalyticsWorkspaceResourceID",
						},
						SecurityMonitoring: &asocontainerservicev1preview.ManagedClusterSecurityProfileDefenderSecurityMonitoring{
							Enabled: ptr.To(true),
						},
					},
					ImageCleaner: &asocontainerservicev1preview.ManagedClusterSecurityProfileImageCleaner{
						Enabled:       ptr.To(true),
						IntervalHours: ptr.To(24),
					},
					WorkloadIdentity: &asocontainerservicev1preview.ManagedClusterSecurityProfileWorkloadIdentity{
						Enabled: ptr.To(true),
					},
				},
			},
	...
	t.Run("with existing preview managed cluster", func(t *testing.T) {
		g := NewGomegaWithT(t)
		...
		existing := &asocontainerservicev1preview.ManagedCluster{
			Spec: asocontainerservicev1preview.ManagedCluster_Spec{
				DnsPrefix:               ptr.To("set by the user"),
				EnablePodSecurityPolicy: ptr.To(true), // set by the user
			},
			Status: asocontainerservicev1preview.ManagedCluster_STATUS{
				AgentPoolProfiles:        []asocontainerservicev1preview.ManagedClusterAgentPoolProfile_STATUS{},
				Tags:                     map[string]string{},
				CurrentKubernetesVersion: ptr.To("1.26.6"),
			},
		}
