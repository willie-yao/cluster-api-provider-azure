...
func (m *Mockclient) DeleteRule(ctx context.Context, spec azure0.ResourceSpecGetter, ruleName string) (azure.FutureAPI, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteRule", ctx, spec, ruleName)
	ret0, _ := ret[0].(azure.FutureAPI)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockclientMockRecorder) DeleteRule(ctx, spec, ruleName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteRule", reflect.TypeOf((*Mockclient)(nil).DeleteRule), ctx, spec, ruleName)
}
