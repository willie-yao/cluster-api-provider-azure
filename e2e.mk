...
.PHONY: test-e2e-run-with-cleanup
test-e2e-run-with-cleanup: ## Run e2e tests with automatic cleanup on success or failure.
...
test-e2e-skip-build-and-push:
	...
	$(MAKE) test-e2e-run-with-cleanup
